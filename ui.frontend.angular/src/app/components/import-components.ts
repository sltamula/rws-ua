 ...
 */
MapTo('rws-ua/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('rws-ua/components/separator')(SeparatorV1Component);

MapTo('rws-ua/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('rws-ua/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('rws-ua/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('rws-ua/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('rws-ua/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('rws-ua/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('rws-ua/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('rws-ua/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('rws-ua/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('rws-ua/components/accordion')(AccordionV1Component);
MapTo('rws-ua/components/tabs')(TabsV1Component);
...
LazyMapTo('rws-ua/components/teaser')(TeaserV1Component);
...
LazyMapTo('rws-ua/components/carousel')(CarouselV1Component);
...
LazyMapTo('rws-ua/components/text')(LazyTextModule, TextEditConfig);